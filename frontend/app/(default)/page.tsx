...
import CompassSvg from "@/app/assets/compass.svg";

import Stains1 from "@/app/assets/stains1.webp";
import Stains2 from "@/app/assets/stains2.webp";

import Pp from "@/app/assets/pp.webp";

import TechAzure from "@/app/assets/tech-azure.webp";
import TechBun from "@/app/assets/tech-bun.webp";
import TechCargo from "@/app/assets/tech-cargo.webp";
import TechDocker from "@/app/assets/tech-docker.webp";
import TechDotnet from "@/app/assets/tech-dotnet.webp";
import TechElysia from "@/app/assets/tech-elysia.svg";
// import TechExpress from "@/app/assets/tech-express.webp";
import TechFirefox from "@/app/assets/tech-firefox.webp";
import TechNext from "@/app/assets/tech-next.webp";
import TechPnpm from "@/app/assets/tech-pnpm.webp";
import TechPrisma from "@/app/assets/tech-prisma.webp";
import TechVercel from "@/app/assets/tech-vercel.webp";
import TechVite from "@/app/assets/tech-vite.webp";
    ...
    <>
      <div id="topBar">
        <div id="topBarMenu">
          ...
          <a href="#techLanguages">Langages</a>
        </div>
      </div>
      <section id="home">
        <div className="background">
          <div id="section1Mouse">
            <Image src={GridSvg} alt="grid background" />
          </div>
          <Image
            src={Stains1}
            style={{ width: "100%", height: "100%", objectFit: "cover" }}
            alt="background stains"
          />
        </div>
        <div className="center">
          <svg
            width="1145"
            height="191"
            viewBox="0 0 1145 191"
            xmlns="http://www.w3.org/2000/svg"
            className="title no-pointer"
          >
            <path
              pathLength="1"
              d="M1 17.3594V190.996H69.3939V156.268H34.697V52.0866L69.3939 17.3636L0 17.3594Z"
            />
            <path
              pathLength="1"
              d="M173.485 190.996H138.788V52.0866L104.091 86.8139L52.0455 86.8182L138.788 1H173.485V190.996Z"
            />
            <path
              pathLength="1"
              d="M277.576 52.0909C315.901 52.0909 346.97 83.1868 346.97 121.545C346.97 159.904 315.901 191 277.576 191C239.251 191 208.182 159.904 208.182 121.545H242.879C242.879 140.725 258.413 156.273 277.576 156.273C296.738 156.273 312.273 140.725 312.273 121.545C312.273 102.366 296.738 86.8182 277.576 86.8182V52.0909Z"
            />
            <path pathLength="1" d="M312.273 191V52.0909H346.97V191H312.273Z" />
            <path
              pathLength="1"
              d="M381.667 138.909V1H416.364V34.7273H485.758V69.4545H416.364V138.909H381.667Z"
            />
            <path pathLength="1" d="M451.061 191V104.182H485.758V191H451.061Z" />
            <path pathLength="1" d="M520.455 191V104.182H555.151V191H520.455Z" />
            <path pathLength="1" d="M555.151 34.7273H520.455V69.4545H555.151V34.7273Z" />
            <path
              pathLength="1"
              d="M589.849 78.1364L615.871 52.0909L659.242 95.5L702.614 52.0909L728.636 78.1364L685.265 121.545L728.636 164.955L702.614 191L589.849 78.1364Z"
            />
            <path
              pathLength="1"
              d="M867.424 191H763.333V156.273H832.727V112.864H763.333V78.1364H867.424V191Z"
            />
            <path
              pathLength="1"
              d="M832.727 52.0909H867.424V1H763.333V34.7273H832.727V52.0909Z"
            />
            <path
              pathLength="1"
              d="M902.121 34.7273V1H971.515V191H936.818V34.7273H902.121Z"
            />
            <path
              pathLength="1"
              d="M1145 121.545C1145 83.1868 1113.93 52.0909 1075.61 52.0909C1037.28 52.0909 1006.21 83.1868 1006.21 121.545C1006.21 159.904 1037.28 191 1075.61 191C1113.93 191 1145 159.904 1145 121.545ZM1075.61 156.273C1056.44 156.273 1040.91 140.708 1040.91 121.545C1040.91 102.383 1056.44 86.8182 1075.61 86.8182C1094.77 86.8182 1110.3 102.383 1110.3 121.545C1110.3 140.708 1094.77 156.273 1075.61 156.273Z"
            />
          </svg>
          <h1 className="subtitle">
            Passionné d&rsquo;<span>informatique</span>
          </h1>
        </div>
      </section>
      <section id="about">
        <h1 className="section-title">
          LUCAS<span>STEPHAN</span>
        </h1>
        <Image className="pp" src={Pp} alt="Lucas Stephan" loading="lazy" />
        <div className="scroller">
          <div className="experience-container current">
            <p>Aujourd&apos;hui</p>
            <div className="experience">
              <span></span>
              <p>
                EPITA - Ecole d&rsquo;ingénieur en informatique
                <br />
                3ème année
              </p>
            </div>
          ...
          <div className="experience-container">
            ...
            <div className="experience">
              <span></span>
              <p>
                Mission intérim chez Galvanoplast
                <br />
                Manutentionnaire
              </p>
            </div>
          ...
          <div className="experience-container">
            ...
            <div className="experience">
              <span></span>
              <p>
                ISM - Lycée Institution Sainte Marie
                <br />
                Spécialités Maths et Physiques-Chimie
              </p>
            </div>
          </div>
        </div>
        <div className="background">
          <Image className="compass" width={780} src={CompassSvg} alt="compass" />
        </div>
      </section>
      <section id="projects">
        ...
        <div className="projects-container">
          <a
            className="project"
            href="https://github.com/matiix310/intra-tweaker"
            target="_blank"
          >
            <p className="extension">.TS</p>
            <p className="title">Intra Tweaker</p>
            <p className="description">
              {/* A firefox extension to add usefull features missing from the EPITA intranet */}
              Une extension firefox qui ajoute des fonctionalités (utiles?) à
              l&rsquo;intranet EPITA
            </p>
            <div className="techs">
              <Image src={TechFirefox} alt="Firefox" />
              <Image src={TechBun} alt="Bun" />
            </div>
          </a>
          <a
            className="project"
            href="https://github.com/matiix310/matiix310.dev"
            target="_blank"
          >
            <p className="extension">.TS</p>
            <p className="title">matiix310.dev</p>
            <p className="description">
              Bien plus qu&rsquo;un site web: Upload / Download, vidéos curl, serveur
              d&rsquo;authentification chiffré et bien plus
            </p>
            <div className="techs">
              <Image src={TechElysia} alt="Elysia" />
              <Image src={TechBun} alt="Bun" />
              <Image src={TechVite} alt="Vite" />
              <Image src={TechDocker} alt="Docker" />
            </div>
          </a>
          <a
            className="project"
            href="https://github.com/matiix310/number-recognition"
            target="_blank"
          >
            <p className="extension">.RS</p>
            <p className="title">Number Recognition</p>
            <p className="description">
              Un réseau de neuronne pouvant être entrainé pour reconnaitre un chiffre dans
              une image
            </p>
            <div className="techs">
              <Image src={TechCargo} alt="Cargo" />
            </div>
          </a>
          <a
            className="project"
            href="https://github.com/matiix310/Epixel"
            target="_blank"
          >
            <p className="extension">.TS</p>
            <p className="title">Epixel</p>
            <p className="description">
              Un site web immitant le r/place avec une authentification et des mécanismes
              anti-triche
            </p>
            <div className="techs">
              <Image src={TechNext} alt="NextJs" />
              <Image src={TechPnpm} alt="pnpm" />
              <Image src={TechVercel} alt="vercel" />
              <Image src={TechPrisma} alt="prisma" />
            </div>
          </a>
          <a
            className="project"
            href="https://github.com/matiix310/Projet-S2"
            target="_blank"
          >
            <p className="extension">.C#</p>
            <p className="title">Termin@l</p>
            <p className="description">
              Projet de groupe pour le S2 à EPITA. C&rsquo;est un RPG où le joueur se
              retrouve immérgé dans un terminal linux
            </p>
            <div className="techs">
              <Image src={TechDotnet} alt="dotnet" />
              <Image src={TechAzure} alt="azure" />
            </div>
          </a>
        </div>
        <div className="background">
      ...
      <section id="techLanguages">
        <h1 className="section-title">LANGAGES</h1>
        <div className="section-devider">
          <p>
            &ldquo;Real programmers can write assembly code in any language.&rdquo;
            <br />
            <br />- Larry Wall
          </p>
          <div className="languages">
            <div style={{ "--color": "#016eb9" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#e3cc1d" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#e8471b" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#e77725" } as React.CSSProperties}>
            ...
            <div style={{ "--color": "#333e9c" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#014e8f" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#762b78" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#646acd" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#b8292b" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#e7bf3c" } as React.CSSProperties}>
              <Image
            ...
            <div style={{ "--color": "#00618a" } as React.CSSProperties}>
              <Image
